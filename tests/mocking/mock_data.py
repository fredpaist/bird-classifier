...
MOCK_BIRD_LOAD_URL = "file:\\" + os.path.abspath("tests/mocking/mock_data.csv")

MOCK_BIRD_1 = Bird(0, "Haemorhous cassinii")
MOCK_BIRD_2 = Bird(1, "Aramus guarauna")
MOCK_BIRD_3 = Bird(2, "Rupornis magnirostris")
MOCK_BIRD_4 = Bird(867, "Corvus brachyrhynchos")
MOCK_BIRD_5 = Bird(781, "Sturnus vulgaris vulgaris")

MOCK_BIRD_IMAGE_URL = "file:\\" + os.path.abspath("tests/mocking/mock_image.jpg")
